...
from app.api import auth, transactions, statistics, accounts, categories, import_apis as import_api, account_balance_history, reminders, reports
...
app.include_router(budget.router, prefix="/api/budgets", tags=["预算管理"])
